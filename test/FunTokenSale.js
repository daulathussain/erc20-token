var FunToken = artifacts.require("../contracts/FunToken.sol");
var FunTokenSale = artifacts.require("../contracts/FunTokenSale.sol");

contract("FunTokenSale", function (accounts) {
  var tokenInstance;
